        ...
        binding.btnConfirmLatLong.setOnClickListener {
            if (lastLatitude != 0.0 && lastLongitude != 0.0) {
                ...
                findNavController().navigate(
                    R.id.google_map_fragment_to_station_details_fragment,
                    bundle
                )
            }
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (ContextCompat.checkSelfPermission(
                ...
                binding.tvAddressAndLocation.text =
                    "Please wait, GPS is trying to find your location. If it does not succeed, then please try by your self."
