...
package hr.sil.android.seeusadmin.remote

import android.content.Context
import hr.sil.android.mplhuber.core.remote.service.AdminAppService
import hr.sil.android.mplhuber.core.remote.service.WebAppService
...
object WSConfig {
    ...
    fun initialize(applicationContext: Context) {
        ...
        log.info("Configuring WSUser clients... ${BuildConfig.API_BASE_URL}, ${BuildConfig.API_CONTEXT}")
