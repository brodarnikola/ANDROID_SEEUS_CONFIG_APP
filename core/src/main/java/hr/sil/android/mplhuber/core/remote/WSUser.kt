...
import hr.sil.android.mplhuber.core.remote.service.UserAppService
...
object WSUser : WSBase() {
    ...
    suspend fun getMasterUnits(): List<RStationUnit>? {
        return wrapAwaitData(
    ...
    suspend fun getGroupMembershipsById(groupId: Int): MutableList<RGroupInfo>? {
        return wrapAwaitData(
    ...
    suspend fun getGroupMembershipsById2(groupId: Long): MutableList<RGroupInfo>? {
        return wrapAwaitData(
                call = UserAppService.service.getGroupMembershipsById2(groupId),
                methodName = "getGroupMembershipsById()",
                defaultNullValue = mutableListOf<RGroupInfo>()
        )
    }
    ...
    suspend fun modifySPLData(macAddress: String): Boolean {
        return wrapAwaitIsSuccessful(
                call = UserAppService.service.deactivateSpl(macAddress),
                methodName = "deactivateSPL()"
        )
    ...
    suspend fun modifyMasterUnit(unit: RStationUnit): Boolean {
        return wrapAwaitIsSuccessful(
                call = UserAppService.service.modifySpl(stationUnit = unit),
