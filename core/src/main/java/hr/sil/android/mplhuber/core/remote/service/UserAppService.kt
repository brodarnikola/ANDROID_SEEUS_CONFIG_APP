...
interface UserAppService {
    ...
    @GET(ENDPOINT_PREFIX + "groupMembers/{id}")
    fun getGroupMembershipsById2(@Path("id") id: Long): Call<MutableList<RGroupInfo>>
    ...
    fun getMasterUnits(): Call<List<RStationUnit>>
    ...
    fun modifySpl(@Body stationUnit: RStationUnit): Call<RStationUnit>
